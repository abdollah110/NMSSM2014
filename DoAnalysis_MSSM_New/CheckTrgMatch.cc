...
//            EleTrgMatched = (Channel == 3) && Trigger_EleTau12 && l1_trgMatche_Ele20Tau20 && l2_trgMatche_Ele20Tau20;
            EleTrgMatched = (Channel == 3) && Trigger_EleTau12 ;
        }
        ...
        if (nbtag > 0 && njets < 2 &&l1_trgMatche_Ele20Tau20 && l2_trgMatche_Ele20Tau20) {
        if ((zCategory ==2 || zCategory ==4) && EleTrgMatched && EL_CUTS && TAU_CUTS && mT < 30 && charge_OS && l2Pt > 30 && l2Pt < 45 && LepIso_category[0] && Iso_category[0]){
            cout<<Event<< "  lepPt"<<l1Pt <<   "tauPT" <<  l2Pt<<"\n";
