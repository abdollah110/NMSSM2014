...
int main(int argc, char** argv) {
    ...
    for (Int_t i = 0; i < nentries_wtn; i++) {
        ...
        bool sel_ZL = (zCategory == 3 || zCategory == 4);
        bool sel_ZJ = (zCategory == 6);
        ...
        //####################################################
        float AllWeight = pu_Weight * eff_Correction * tauESWeight * WeightEmbed * HiggsPtReweight[1] * EleTauFRWeight * TopPtReweighting;
        ...
        bool MuTrgMatched = (Channel == 1) && Trigger_MuTau12 && l1_trgMatche_Mu17Tau20 && l2_trgMatche_Mu17Tau20;
        bool EleTrgMatched = (Channel == 3) && Trigger_EleTau12 && l1_trgMatche_Ele20Tau20 && l2_trgMatche_Ele20Tau20;
        ...
        bool TAU_CUTS = TauVtxdZ && Tau_DMF && Tau_antiEl && Tau_antiMu;
