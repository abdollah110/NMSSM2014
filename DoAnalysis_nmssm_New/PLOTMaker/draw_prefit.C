...
void draw_prefit() {
    draw_prefit_Sample("TotalRootForLimit_etau_8TeV.root", "eleTau_inclusive/", 5000, "m_{#tau#tau}[GeV]","PLOT_eleTau_inclusive_m");
    draw_prefit_Sample("TotalRootForLimit_muTau_8TeV.root", "muTau_inclusive/", 100000, "m_{#tau#tau}[GeV]","PLOT_muTau_inclusive_m" );
    draw_prefit_Sample("TotalRootForLimit_etau_8TeV.root", "eleTau_btag/", 500, "m_{#tau#tau}[GeV]","PLOT_eleTau_btag_m");
    draw_prefit_Sample("TotalRootForLimit_muTau_8TeV.root", "muTau_btag/", 800, "m_{#tau#tau}[GeV]","PLOT_muTau_btag_m" );
};
