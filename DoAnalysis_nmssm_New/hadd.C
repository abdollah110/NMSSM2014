...
void hadd_TT() {
    ...
    for (int i = 0; i < numBG; i++) {
        ...
        std::string MMM = "../FileROOT/nmssmROOTFiles/" + string(Top_BackGround[i]) + "_8TeV.root";
...
void hadd_VV() {
    ...
    for (int i = 0; i < numBG; i++) {
        ...
        std::string MMM = "../FileROOT/nmssmROOTFiles/" + string(DiBoson_BackGround[i]) + "_8TeV.root";
        TFile * myFile = new TFile(MMM.c_str());
