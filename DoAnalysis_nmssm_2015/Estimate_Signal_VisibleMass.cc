...
//<<<<<<< HEAD
            ...
            TLorentzVector LorTauUp;
                
            LorTau.SetPxPyPzE(l2Px, l2Py, l2Pz,l2E);
            LorTauDown=LorTau*0.97;
            LorTauUp=LorTau*1.03;
                
            double VisibleMass= InvarMass_F(l1E, LorTau.E(), l1Px, LorTau.Px(), l1Py, LorTau.Py(), l1Pz, LorTau.Pz());
            double VisibleMassDown= InvarMass_F(l1E, LorTauDown.E(), l1Px, LorTauDown.Px(), l1Py, LorTauDown.Py(), l1Pz, LorTauDown.Pz());
            double VisibleMassUp= InvarMass_F(l1E, LorTauUp.E(), l1Px, LorTauUp.Px(), l1Py, LorTauUp.Py(), l1Pz, LorTauUp.Pz());
