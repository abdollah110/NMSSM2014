...
def make2DTable(Observable,PostFix,CoMEnergy):
    myOut = TFile("Yield"+CoMEnergy+Observable+PostFix+".root", 'RECREATE')
...
#        ########################################################################
    ...
    myCanvas.SaveAs("tableAll"+Observable+PostFix+CoMEnergy+".pdf")
...
#    make2DTable("_visibleMass","", "_8TeV")
    ...
    make2DTable("_SVMass_TrgUncUp","", "_8TeV")
    make2DTable("_SVMass_TrgUncDown","", "_8TeV")
