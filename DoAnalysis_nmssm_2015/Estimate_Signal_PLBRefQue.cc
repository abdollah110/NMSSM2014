...
//            std::string index[size_mssmC] = {"_inclusive",  "_btag", "_btagLoose"};
            ...
            bool selection_btagDown = nbtag > 1 && njets > 1 && l2Pt * (1 + tauESc) > cutonTaupt;
            ...
            bool selection_btag = nbtag > 1 && njets > 1 && l2Pt * (1 + tauESc) > cutonTaupt;
            ...
            bool selection_btagUp = nbtag > 1 && njets > 1 && l2Pt * (1 + tauESc) > cutonTaupt;
...
//            float LumiWeight = 1;
            ...
            // Muon Selection
            //####################################################
            bool Mu_PtEta = l1Pt > 25 && fabs(l1Eta) < 2.1;
//                bool Mu_PtEta = l1Pt > 20 && fabs(l1Eta) < 2.1;  //Changing MUpt from 18 to 20
            ...
            ZimpactTau = 1000;
            //####################################################
            bool El_PtEta = l1Pt > 25 && fabs(l1Eta) < 2.1;
