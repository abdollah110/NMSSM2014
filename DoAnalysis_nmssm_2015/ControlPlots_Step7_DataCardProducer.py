...
TopUncertainty = False
TopShapeUncertainty= False
ZLUncertainty = False
WShapeUncertainty = False
verbos_ = False
...
#Binning_NoBTag = array.array("d",[0,5,10,15,20,25,30,35,40,45,50,55,60,70,80,100,140,200])
#Binning_BTag = array.array("d",[0,5,10,15,20,25,30,35,40,45,50,55,60,70,80,100,140,200])
#Binning_BTag = array.array("d",[-2.5,-2.25,-2,-1.75,-1.5,-1.25,-1,-0.75,-0.5,-0.25,0,0.25,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5])
#Binning_NoBTag = array.array("d",[-2.5,-2.25,-2,-1.75,-1.5,-1.25,-1,-0.75,-0.5,-0.25,0,0.25,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5])
Binning_BTag = array.array("d",[0,1,2,3,4,5])
Binning_NoBTag = array.array("d",[0,1,2,3,4,5])
#TauScale = ["Down", "", "Up"]
TauScale = [""]
POSTFIX=[""]
...
def _Return_QCD_Shape(channel,cat,Histo,UncShape,PostFix,CoMEnergy):
    ...
    HistoNorm =  myfile.Get(channel+Histo + cat+ "FROSSS"+UncShape+PostFix)
#    if cat=="_btag" : cat = "_btagLoose"   FIXME
    HistoShape =  myfile.Get(channel+Histo + cat+ "FROSSS"+UncShape+PostFix)
...
#def _Return_TOP_Shape(channel,cat,HistoName,PostFix,CoMEnergy,changeHistoName):
    NewFile=TFile("Extra/XXX.root","RECREATE")
    NewHIST =TH1F("XXX","",high_bin,0,TauEta)
...
if __name__ == "__main__":
    ...
    MakeTheHistogram("mutau","_nBjets","_8TeV",0)
    MakeTheHistogram("etau","_nBjets","_8TeV",1)
#    MakeTheHistogram("mutau","_TauEta","_8TeV",0)
#    MakeTheHistogram("etau","_TauEta","_8TeV",1)
#    MakeTheHistogram("mutau","_LepPt","_8TeV",0)
#    MakeTheHistogram("etau","_LepPt","_8TeV",1)
