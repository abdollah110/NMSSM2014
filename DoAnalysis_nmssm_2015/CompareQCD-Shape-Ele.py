...
rbin=5
Histo_antiMuantiTau=File_antiMuantiTau.Get("etau_QCDShapeNormTotalFROSSS_btag")
Histo_antiMuantiTau.Rebin(rbin)

Histo_MuantiTau=File_MuantiTau.Get("etau_QCDShapeNormTotalFROSSS_btag")
Histo_MuantiTau.Rebin(rbin)

Histo_antiMuTau=File_antiMuTau.Get("etau_QCDShapeNormTotalFROSSS_btag")
Histo_antiMuTau.Rebin(rbin)

#c1.SetOptStat(0);
Histo_antiMuantiTau.GetYaxis().SetRangeUser(0,25)
...
tex =TLatex(10,23,"QCD Shape Comparison in Different Control Regions (e#tau)");
tex.SetTextSize(.035);
#tex.SetLineWidth(2);
tex.Draw();
